...
module RubyAMF
  module Configuration
    ...
    #
     ...
     #ClassMappings.register(:actionscript => 'User', :ruby => 'User', :type => 'active_record', :associations=> ["messages", "user_type"])
       ClassMappings.register(:actionscript => 'User', :ruby => 'User', :type => 'active_record', :associations=> ["messages", "user_type"], :methods => ["age"])
     #ClassMappings.register(:actionscript => 'Message', :ruby => 'Message', :type => 'active_record', :associations=> ["user"])
